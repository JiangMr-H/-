			...
			<section class="content">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							<!--工具栏-->
							<form action="${pageContext.request.contextPath}/Pay/findByCondition.do" method="post">
							...
							<table id="dataList"
								...
								<tbody>
									<c:forEach items="${pageInfo.list}" var="pay" >
										<tr>
											<td class="text-center">${pay.userId }</td>
											<td class="text-center">${pay.username }</td>
											<td class="text-center">${pay.monad }</td>
											<td class="text-center">${pay.sex }</td>
											<td class="text-center">${pay.post }</td>
											<td class="text-center">${pay.phone }</td>
											<td class="text-center">${pay.wageSystem }</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/pay/findAll.do?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/pay/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="${pageInfo.pageNum}" end="${pageInfo.pageNum}" var="pageNum">
									<li><a href="${pageContext.request.contextPath}/pay/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/pay/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/pay/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
