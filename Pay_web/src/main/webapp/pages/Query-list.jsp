							...
							<div class="pull-right">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" onclick="location.href='${pageContext.request.contextPath}/AddressBook/findAll.do?page=1&size=${pageInfo.pageSize}'" class="btn btn-default" title="返回">
											<i class="fa fa-backward"></i> 返回
										</button>
										<button type="button" onclick="location.href='${pageContext.request.contextPath}/AddressBook/findAll.do?page=1&size=${pageInfo.pageSize}'" class="btn btn-default" title="刷新">
